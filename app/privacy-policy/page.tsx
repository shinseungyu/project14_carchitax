...
export const metadata: Metadata = {
  title: '개인정보 처리방침 | 자동차 취등록세 계산기',
  description: '자동차 취등록세 계산기 서비스의 개인정보 처리방침입니다.',
  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'sans-serif', color: '#333', lineHeight: '1.8' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>본 개인정보 처리방침은 <strong>carprotax.com</strong> (이하 &quot;사이트&quot;)이 운영하는 &quot;자동차 취등록세 계산기&quot; 서비스와 관련하여, 이용자의 개인정보를 어떻게 수집·이용·보호하는지를 설명합니다. 본 사이트를 이용함으로써 이 방침에 동의하는 것으로 간주합니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>본 사이트는 직접적으로 개인정보를 저장하거나 보관하지 않습니다. Google Analytics 및 Google AdSense를 통해 수집된 데이터는 각 서비스의 방침에 따라 관리됩니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>본 개인정보 처리방침은 관련 법령 및 서비스 변경에 따라 수정될 수 있습니다. 변경 사항은 본 페이지에 게시됩니다.</p>
      </section>
