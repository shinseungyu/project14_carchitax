...
export const metadata: Metadata = {
  title: '이용약관 | 자동차 취등록세 계산기',
  description: '자동차 취등록세 계산기 서비스의 이용약관입니다.',
...
export default function TermsOfServicePage() {
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'sans-serif', color: '#333', lineHeight: '1.8' }}>
      ...
      <p style={{ color: '#888', marginBottom: '32px' }}>최종 업데이트: 2026년 3월 18일</p>

      <section style={{ marginBottom: '32px' }}>
        <h2 style={{ fontSize: '1.3rem', fontWeight: 'bold', marginBottom: '12px', borderBottom: '2px solid #eee', paddingBottom: '8px' }}>제1조 (목적)</h2>
        <p>본 약관은 <strong>carprotax.com</strong> (이하 &quot;사이트&quot;)이 제공하는 &quot;자동차 취등록세 계산기&quot; 서비스(이하 &quot;서비스&quot;)의 이용 조건 및 절차, 이용자와 사이트 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <ul style={{ paddingLeft: '20px', marginTop: '8px' }}>
          <li>신차 자동차 취등록세 자동 계산 서비스</li>
          <li>중고차 취등록세 (잔가율 기반) 계산 서비스</li>
          <li>지역별 공채 비용 계산</li>
          <li>경차·전기차·다자녀·복지 감면 자동 반영</li>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>본 서비스는 회원가입 없이 무료로 이용할 수 있습니다. 이용자는 서비스를 이용함으로써 본 약관에 동의한 것으로 간주합니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>본 사이트는 Google AdSense를 통한 광고를 게재합니다. 광고는 제3자(Google)에 의해 제공되며, 본 사이트는 해당 광고 내용에 대한 책임을 지지 않습니다.</p>
      </section>

      <section style={{ marginBottom: '32px' }}>
        <h2 style={{ fontSize: '1.3rem', fontWeight: 'bold', marginBottom: '12px', borderBottom: '2px solid #eee', paddingBottom: '8px' }}>제6조 (면책 조항)</h2>
        <p>본 사이트에서 제공하는 취등록세 계산 결과는 <strong>참고용</strong>이며, 법적 효력이 없습니다. 실제 세액은 관할 시·군·구청 기준에 따라 달라질 수 있으며, 정확한 세액은 관할 기관에서 확인하시기 바랍니다. 계산 결과에 따른 실제 세금 납부 결과에 대해 사이트는 책임을 지지 않습니다.</p>
      </section>

      <section style={{ marginBottom: '32px' }}>
        <h2 style={{ fontSize: '1.3rem', fontWeight: 'bold', marginBottom: '12px', borderBottom: '2px solid #eee', paddingBottom: '8px' }}>제7조 (지적 재산권)</h2>
        <p>본 사이트의 모든 콘텐츠(텍스트, 이미지, 로고 등)에 대한 저작권은 사이트에 귀속됩니다. 이용자는 사이트의 사전 동의 없이 콘텐츠를 무단으로 사용할 수 없습니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p style={{ marginTop: '8px' }}>이메일: <a href="mailto:tlsfkaus0711@gmail.com" style={{ color: '#2563eb' }}>tlsfkaus0711@gmail.com</a></p>
      </section>
