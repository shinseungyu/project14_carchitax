...
export const metadata: Metadata = {
  title: '쿠키 정책 | 자동차 취등록세 계산기',
  description: '자동차 취등록세 계산기 서비스의 쿠키 정책입니다.',
  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'sans-serif', color: '#333', lineHeight: '1.8' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>쿠키(Cookie)는 웹사이트가 이용자의 브라우저에 저장하는 작은 텍스트 파일입니다. 쿠키는 이용자의 방문 기록, 환경 설정 등을 저장하여 더 나은 사용자 경험을 제공하는 데 활용됩니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>사이트 이용 현황을 파악하기 위해 <strong>Google Analytics</strong>를 사용합니다. 방문자 수, 페이지 조회수, 체류 시간 등의 데이터를 익명으로 수집합니다.</p>

        <h3 style={{ fontSize: '1.1rem', fontWeight: 'bold', marginTop: '16px', marginBottom: '8px' }}>③ 광고 쿠키 (Google AdSense)</h3>
        <p>본 사이트는 <strong>Google AdSense</strong>를 통해 광고를 제공합니다. Google은 다음 목적으로 쿠키를 사용합니다:</p>
        <ul style={{ paddingLeft: '20px', marginTop: '8px' }}>
          <li>이용자의 관심사에 맞는 맞춤형 광고 제공</li>
          <li>광고 클릭 및 전환 측정</li>
          <li>광고 빈도 제어</li>
        </ul>
        <p style={{ marginTop: '12px' }}>Google AdSense 쿠키는 이용자의 다른 웹사이트 방문 기록을 기반으로 작동할 수 있습니다. 이는 Google의 <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb' }}>개인정보처리방침</a>을 따릅니다.</p>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p style={{ marginTop: '12px', backgroundColor: '#fff7ed', padding: '12px', borderRadius: '8px', borderLeft: '4px solid #f97316' }}>
